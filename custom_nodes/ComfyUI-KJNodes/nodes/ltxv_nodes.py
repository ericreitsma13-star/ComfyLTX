try:
    ...
    # ComfyUI 0.13 removed this private helper. Fall back to no-op so nodes load.
    def _append_guide_attention_entry(positive, negative, pre_filter_count, guide_latent_shape, strength=1.0):
