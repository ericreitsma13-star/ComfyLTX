...
echo "=== Dark Cinematic Content Pack ==="
echo

echo "[1/2] Generating dark cinematic prompts via Llama 3.3 70B..."
STYLE=cinematic python3 "$HOST_MOUNT/mignola_prompter.py" --style cinematic
echo "Done."
echo
...
echo "=== Dark cinematic test complete ==="
'

echo
echo "Outputs: $OUTPUT_DIR"
ls -lh "$OUTPUT_DIR"/*.png 2>/dev/null | grep -v "warm_\|cold\|text\|pipeline_\|mignola"
