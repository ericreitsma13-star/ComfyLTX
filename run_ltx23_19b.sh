...
echo "=== LTX-2.3 19B Distilled FP8 ==="
echo "Checkpoint: $CHECKPOINT"
echo "Upscaler:   $UPSCALER"
echo "Gemma root: $GEMMA_ROOT"
echo "Output:     $OUTPUT_DIR/ltx23_19b"

docker run --rm \
  --name ltx23-19b-pipeline \
  --shm-size=16g \
...
echo "Running LTX-2.3 19B pipeline..."
python /opt/comfy-toolbox/ltx23_19b_infer.py "$@"

echo "=== LTX-2.3 19B pipeline complete ==="
' "ltx23_19b" "$@"
